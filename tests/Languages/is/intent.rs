...
fn silent_intent_mi() {
    ...
    test("is", "SimpleSpeak", expr, "2");
    test("is", "ClearSpeak", expr, "2");
}
...
fn silent_intent_msup() {
    ...
    test("is", "SimpleSpeak", expr, "stórt h 2");
    test("is", "ClearSpeak", expr, "stórt h 2");
}
...
fn intent_prob_x() {
    ...
    test("is", "ClearSpeak", expr, "líkindi á, x");
}
